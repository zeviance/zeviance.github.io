...
var _replicateJs = require("replicate-js");
var _replicateJsDefault = parcelHelpers.interopDefault(_replicateJs);
...
const replicate = new (0, _replicateJsDefault.default)({
...
function saveCapture() {
    (0, _html2CanvasDefault.default)(canvas).then(function(canvas) {
...
for (const ev of [
    "touchstart",
    "mousedown"
])canvas.addEventListener(ev, function(e1) {
    let pressure1 = 0.1;
    let x, y;
    if (e1.touches && e1.touches[0] && typeof e1.touches[0]["force"] !== "undefined") {
        if (e1.touches[0]["force"] > 0) pressure1 = e1.touches[0]["force"];
        x = translatedXCoor(e1.touches[0].pageX) * scaleFactor;
        y = translatedYCoor(e1.touches[0].pageY) * scaleFactor;
    } else {
        pressure1 = 1.0;
        x = translatedXCoor(e1.pageX) * scaleFactor;
        y = translatedYCoor(e1.pageY) * scaleFactor;
    }
    isMousedown = true;
    lineWidth = Math.log(pressure1 + 1) * 40;
...
for (const ev1 of [
    "touchmove",
    "mousemove"
])canvas.addEventListener(ev1, function(e1) {
    ...
    // smoothen line width
    lineWidth = Math.log(pressure1 + 1) * 8 + lineWidth * 0.8;
    points.push({
        x,
        y,
        lineWidth
...
for (const ev2 of [
    ...
    "touchleave",
    "mouseup"
])canvas.addEventListener(ev2, function(e1) {
    isMousedown = false;
...
async function postPromptsToReplicateService(inputPrompt, localImageUrl) {
    ...
    if (localImageUrl.length > 0) inputParam.init_image = localImageUrl;
    let stableDiffusionModel = await replicate.models.get("stability-ai/stable-diffusion/");
    let stableDiffusionImages = await stableDiffusionModel.predict(inputParam).then((data)=>{
...
},{"html2canvas":"j1W5C","replicate-js":"hvZug","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"j1W5C":[function(require,module,exports) {
/*!
...
},{}],"hvZug":[function(require,module,exports) {
// Default configuration
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Replicate", ()=>Replicate);
parcelHelpers.export(exports, "ReplicateModel", ()=>ReplicateModel);
// This class just makes it a bit easier to call fetch -- interface similar to the axios library
parcelHelpers.export(exports, "DefaultFetchHTTPClient", ()=>DefaultFetchHTTPClient);
...
class Replicate {
    constructor({ token , proxyUrl , httpClient , pollingInterval  } = {}){
        ...
        this.models = {
            get: (path, version = null)=>ReplicateModel.fetch({
                    path,
                    version,
                    replicate: this
                })
...
class ReplicateModel {
    ...
    async getModelDetails() {
        ...
        if (this.version && this.version !== this.modelDetails.id) console.warn(`Model (version:${this.version}) not found, defaulting to ${mostRecentVersion.id}`);
    }
...
class DefaultFetchHTTPClient {
    ...
    async importFetch() {
        if (isNode && !globalThis.fetch) globalThis.fetch = (await require("46559184379483c1"))["default"];
    }
    async get({ url  }) {
...
},{"process":"d5jf4","46559184379483c1":"4QJFq","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d5jf4":[function(require,module,exports) {
...
},{}],"4QJFq":[function(require,module,exports) {
module.exports = require("./helpers/browser/js-loader")(require("./helpers/bundle-url").getBundleURL("bLxZJ") + "node-fetch.646caad3.js" + "?" + Date.now()).catch((err)=>{
...
},{}]},["ShInH","8lqZg"], "8lqZg", "parcelRequire3f75")
