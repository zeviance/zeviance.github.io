...
var _replicateapi = require("./replicateapi");
var _colorCanvas = require("./colorCanvas");
...
function reset() {
    (0, _colorCanvas.resetCanvas)();
    // clear prompt
    inputField.value = "";
}
resetBtn.onclick = reset;
function saveCapture() {
    (0, _html2CanvasDefault.default)(canvas, {
        scale: 0.5
    }).then(function(canvas) {
        // check if prompt is empty
        let inputFieldText = inputField.value.trim();
        let localImageDataURL = !(0, _colorCanvas.isBlank) ? canvas.toDataURL("image/jpg", 0.75) : "";
...
async function postPromptsToReplicateService(inputPrompt, localImageUrl) {
    (0, _replicateapi.callReplicateService)(inputPrompt, localImageUrl).then((data)=>{
...
},{"html2canvas":"j1W5C","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./colorCanvas":"clnLq","./replicateapi":"ktx5l"}],"j1W5C":[function(require,module,exports) {
/*!
...
},{}],"ktx5l":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "callReplicateService", ()=>callReplicateService);
...
async function callReplicateService(inputPrompt, localImageUrl) {
...
},{"replicate-js":"hvZug","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hvZug":[function(require,module,exports) {
...
},{}],"lkOL6":[function(require,module,exports) {
// TinyColor v1.4.2
