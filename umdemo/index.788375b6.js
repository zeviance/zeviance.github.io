...
})({"jDlII":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "67c1977c788375b6";
"use strict";
...
},{}],"clnLq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "isBlank", ()=>isBlank);
...
const varyColour = (sourceColour)=>{
    ...
    const c = (0, _tinycolor2Default.default)(sourceColour);
...
const getNewAngle = (origin, destination, oldAngle)=>{
    ...
    if (typeof oldAngle === "undefined") return bearing;
...
const mouseMove = (evt)=>{
    if (!drawing) return;
    continueStroke([
        translatedXCoor(evt.offsetX),
        translatedYCoor(evt.offsetY)
    ], evt);
};
const mouseDown = (evt)=>{
    if (drawing) return;
...
function determinePressureScale(evt) {
    ...
    if (evt && evt.touches && evt.touches[0] && typeof evt.touches[0]["force"] !== "undefined") {
        if (evt.touches[0]["force"] > 0) pressure = evt.touches[0]["force"] * TOUCH_FORCE_MULTIPLIER;
    }
    /*
...
},{"tinycolor2":"lkOL6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jDlII"], null, "parcelRequire3f75")

//# sourceMappingURL=index.788375b6.js.map
